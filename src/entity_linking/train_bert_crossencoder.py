...
def parse_args():
    ...
    parser.add_argument("--negatives", type=int, help="epochs")
    ...
    parser.add_argument("--without_context", action="store_true", help="whether using inbatch negative")
...
def main():
    ...
    mention_dataset = MentionDataset(args.mention_dataset, index, mention_tokenizer, preprocessed=args.mention_preprocessed, return_json=True, without_context=args.without_context, use_index=True)
